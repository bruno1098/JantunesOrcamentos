...
import { StickyCartBar } from '@/components/orcamento/sticky-cart-bar';
...
// Root layout do grupo (site) — todas as rotas públicas. Independente
// do app/admin/layout.tsx (ver app/admin/layout.tsx para o porquê:
// "Multiple Root Layouts" via Route Groups, cada um com seu próprio
// <html>/<body>, sem herança entre os dois).
