...
import { ProgressLoading } from "@/components/orcamento/progress-loading";
...
export default function OrcamentoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // TODO: reativar envio de e-mail (SendGrid via /api/send-email).
      // Bypass temporário (Fase 5) — a API estava bloqueando/atrasando os
      // testes manuais do fluxo de orçamento. O pedido já fica salvo e
      // visível em /admin e /meus-pedidos sem depender do e-mail.
      // await Promise.all([
      //   enviarEmail({
      //     para: email,
      ...
      // Mostra o modal de sucesso imediatamente após salvar
      setShowSuccess(true);
      clearCart(); // Limpa o carrinho

      // O redirecionamento acontece no callback do modal (onClose),
      // sem colocar o e-mail na URL — ver app/meus-pedidos/page.tsx.
      ...
      {showSuccess && (
        <SuccessAnimation
          onClose={() => {
            ...
            // Sem e-mail na URL: em /meus-pedidos o cliente digita o
            // e-mail de novo pra consultar (ver Etapa 5 da migração).
        ...
        >
          <div className="bg-background rounded-lg max-w-2xl w-full p-6 space-y-4">
            ...
            <div className="text-center text-sm text-muted-foreground mb-2">
              Seria este o local do seu evento? Se precisar, arraste o pino
              até a posição exata.
            </div>
            ...
            <div className="h-[300px] rounded-lg overflow-hidden border">
              <MapaEndereco
                ...
                onPositionChange={(lat, lng) =>
                  setEndereco((prev) => ({ ...prev, latitude: lat, longitude: lng }))
                }
              />
            </div>
