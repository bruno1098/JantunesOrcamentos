    ...
    <Document>
      <Page size="A4" style={styles.page} wrap={false}>
        ...
        <View style={[styles.footer, { marginTop: 20 }]}>
          <Text style={[styles.jantunes, { marginBottom: 4 }]}>{CONTATO.nomeEmpresa.toUpperCase()}</Text>

          <Text style={styles.label}>CNPJ: 18.523.276/0001-10</Text>
          <Text style={styles.label}>Tel: {CONTATO.telefoneExibicao} | Email: {CONTATO.email}</Text>
