...
export const WhatsAppButton = () => {
  ...
  const phoneNumber = CONTATO.whatsapp;
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          animate={{ scale: 1 }}
          exit={{ scale: 0 }}
          // bottom-20 no mobile (não bottom-4): dá espaço pra StickyCartBar,
          // que ocupa a largura inteira do rodapé quando há itens no carrinho.
